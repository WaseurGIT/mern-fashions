...
const Boot = ({ boot }) => {
  const { name, rating, features, image, price } = boot;

  return (
    <div className="card w-86 mx-auto mt-10 transition-all duration-700 ease-in-out hover:scale-105 hover:shadow-xl">
