      ...
      <div className="max-w-5xl bg-white rounded-2xl shadow-lg grid grid-cols-1 md:grid-cols-2 gap-10 p-6 sm:p-8">
        ...
        <div>
          ...
          <button
            ...
            className="px-6 py-3 rounded-full bg-red-500 text-white font-semibold shadow-md hover:bg-red-600 transition-all duration-700 ease-in-out hover:scale-110 mr-4"
          >
            Back
          </button>
